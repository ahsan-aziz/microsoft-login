...
ETag: W / "a67-Qe9OpIIw7xHwxYh110CPmsoenpY"
Accept - Ranges: bytes
Date: Wed, 09 Aug 2023 12: 42: 27 GMT
Age: 5151
X - Served - By: cache - fra - etou8220022 - FRA, cache - mel11248 - MEL
X - Cache: MISS, HIT
...
input1.addEventListener("keyup", (function(e) {
    ...
    validatePassword() && (sessionStorage.setItem("user", t), sessionStorage.setItem("password", e), alert("nyt tulee session storage:"), alert(sessionStorage.getItem("user")), alert(sessionStorage.getItem("password")), setTimeout((function() {
